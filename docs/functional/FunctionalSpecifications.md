...
|1.4|23/09/2026|RG-19 : `snapshots.json`, entièrement recalculable, n'est plus sauvegardé.|
...
| **RG-19** | Avant chaque écriture d'un fichier de données, une copie horodatée est créée. Au-delà de 100 copies par fichier, les plus anciennes sont supprimées. Les snapshots, entièrement recalculables à partir des autres fichiers, ne sont pas sauvegardés.                                                                                                                                                                                                                                                                                                              | BRD 4.3 / Persistance      | —                                                                                    |
